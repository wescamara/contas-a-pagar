...
public class UpdateSituationContaAdapterTest {

    @InjectMocks
    private UpdateSituationContaAdapter updateSituationContaAdapter;
    ...
    void shouldUpdateSituationContaWithSuccess() {
        ...
        updateSituationContaAdapter.update(contaMock);
